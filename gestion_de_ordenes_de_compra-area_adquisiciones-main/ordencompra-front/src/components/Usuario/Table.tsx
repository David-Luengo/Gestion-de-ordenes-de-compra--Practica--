...
import { Proveedor, SolicitudDeUsuarioConFecha } from "@interfaces/interfaces";
...
export default function TablaSolicitudes() {
  ...
  //grafico
  const [solicitudesPorFecha, setSolicitudesPorFecha] = useState<
    { fecha: string; cantidad: number }[]
  >([]);

  const [chartInstance, setChartInstance] = useState<Chart | null>(null);

  const esAutenticacionValida = useVerificarAutenticacion("Solicitante");
          ...
          <div className="dashboard-container">
            <div className="row mt-2">
              <div className="col-xl-6 col-md-12 col-sm-12">
                <div
                  className="info-container bg-white p-2 rounded-md"
                  style={{ margin: "30px" }}
                >
